    ...
    navbarPage("Motor Trend Data Analysis Application",
               ...
               tabPanel("About",
                        ...
                        div("Motor Trend Data Analysis is an interactive
                            ...
                            on GitHub:",
                            br(),br(),
                            a(href = "https://github.com/oraclejavanet/developing-data-products-course-project-3",
                            "https://github.com/oraclejavanet/developing-data-products-course-project-3"))
               )
    )
)
